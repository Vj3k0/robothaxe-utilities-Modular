...
robothaxe.utilities.modular.tests.base.ModuleCommandMapTest.prototype = {
	...
	,testExecutesCommand: function(factory) {
		this._commandMap.mapEvent("sample event",robothaxe.utilities.modular.tests.support.TestCommand,robothaxe.utilities.modular.tests.support.TestModuleEvent);
		this._moduleEventDispatcher.dispatchEvent(new robothaxe.utilities.modular.tests.support.TestModuleEvent("sample event"));
		var isExecuted = robothaxe.utilities.modular.tests.support.TestCommand.isExecuted;
		massive.munit.Assert.isTrue(isExecuted,{ fileName : "ModuleCommandMapTest.hx", lineNumber : 75, className : "robothaxe.utilities.modular.tests.base.ModuleCommandMapTest", methodName : "testExecutesCommand"});
	}
	,handleEventDispatch: function(event) {
		massive.munit.Assert.areEqual("custom event",event.type,{ fileName : "ModuleCommandMapTest.hx", lineNumber : 81, className : "robothaxe.utilities.modular.tests.base.ModuleCommandMapTest", methodName : "handleEventDispatch"});
	}
