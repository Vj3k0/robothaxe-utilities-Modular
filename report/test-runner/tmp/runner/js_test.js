...
robothaxe.utilities.modular.tests.base.ModuleCommandMapTest.prototype = {
	...
	,handleEventDispatch: function(event) {
		massive.munit.Assert.areEqual("custom event",event.type,{ fileName : "ModuleCommandMapTest.hx", lineNumber : 80, className : "robothaxe.utilities.modular.tests.base.ModuleCommandMapTest", methodName : "handleEventDispatch"});
	}
